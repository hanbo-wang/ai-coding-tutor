...
async def save_message(
    ...
    msg = ChatMessage(
        ...
        role=role,
        content=content,
        programming_difficulty=programming_difficulty,
        maths_difficulty=maths_difficulty,
        programming_hint_level_used=programming_hint_level_used,
        maths_hint_level_used=maths_hint_level_used,
    ...
    return [
        {
            ...
            "role": m.role,
            "content": m.content,
            "programming_difficulty": m.programming_difficulty,
            "maths_difficulty": m.maths_difficulty,
            "programming_hint_level_used": m.programming_hint_level_used,
            "maths_hint_level_used": m.maths_hint_level_used,
            "attachments": [
