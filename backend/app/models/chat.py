...
class ChatMessage(Base):
    ...
    programming_difficulty: Mapped[int | None] = mapped_column(Integer, nullable=True)
    maths_difficulty: Mapped[int | None] = mapped_column(Integer, nullable=True)
    programming_hint_level_used: Mapped[int | None] = mapped_column(Integer, nullable=True)
    maths_hint_level_used: Mapped[int | None] = mapped_column(Integer, nullable=True)
